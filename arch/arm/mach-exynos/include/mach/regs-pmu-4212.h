...
//Apollo +
#define EXYNOS4_PS_HOLD_CONTROL               S5P_PMUREG(0x330C)
#define EXYNOS4_ARM_CORE0_CONFIGURATION       S5P_PMUREG(0x2000)
#define EXYNOS4_ARM_CORE0_STATUS              S5P_PMUREG(0x2004)
#define EXYNOS4_ARM_CORE0_OPTION              S5P_PMUREG(0x2008)
#define EXYNOS4_ARM_CORE1_CONFIGURATION       S5P_PMUREG(0x2080)
#define EXYNOS4_ARM_CORE1_STATUS              S5P_PMUREG(0x2084)
#define EXYNOS4_ARM_CORE1_OPTION              S5P_PMUREG(0x2088)
#define EXYNOS4_ARM_COMMON_OPTION             S5P_PMUREG(0x2408)
#define EXYNOS4_ARM_CPU_L2_0_CONFIGURATION    S5P_PMUREG(0x2600)
#define EXYNOS4_ARM_CPU_L2_0_STATUS           S5P_PMUREG(0x2604)
#define EXYNOS4_ARM_CPU_L2_1_CONFIGURATION    S5P_PMUREG(0x2620)
#define EXYNOS4_ARM_CPU_L2_1_STATUS           S5P_PMUREG(0x2624)
#define EXYNOS4_PAD_RETENTION_MAUDIO_OPTION   S5P_PMUREG(0x3028)
#define EXYNOS4_PAD_RETENTION_GPIO_OPTION     S5P_PMUREG(0x3108)
#define EXYNOS4_PAD_RETENTION_UART_OPTION     S5P_PMUREG(0x3128)
#define EXYNOS4_PAD_RETENTION_MMCA_OPTION     S5P_PMUREG(0x3148)
#define EXYNOS4_PAD_RETENTION_MMCB_OPTION     S5P_PMUREG(0x3168)
#define EXYNOS4_PAD_RETENTION_EBIA_OPTION     S5P_PMUREG(0x3188)
#define EXYNOS4_PAD_RETENTION_EBIB_OPTION     S5P_PMUREG(0x31A8)
#define EXYNOS4_CAM_CONFIGURATION             S5P_PMUREG(0x3C00)
#define EXYNOS4_CAM_STATUS                    S5P_PMUREG(0x3C04)
#define EXYNOS4_CAM_OPTION                    S5P_PMUREG(0x3C08)
#define EXYNOS4_TV_CONFIGURATION              S5P_PMUREG(0x3C20)
#define EXYNOS4_TV_STATUS                     S5P_PMUREG(0x3C24)
#define EXYNOS4_TV_OPTION                     S5P_PMUREG(0x3C28)
#define EXYNOS4_MFC_CONFIGURATION             S5P_PMUREG(0x3C40)
#define EXYNOS4_MFC_STATUS                    S5P_PMUREG(0x3C44)
#define EXYNOS4_MFC_OPTION                    S5P_PMUREG(0x3C48)
#define EXYNOS4_G3D_CONFIGURATION             S5P_PMUREG(0x3C60)
#define EXYNOS4_G3D_STATUS                    S5P_PMUREG(0x3C64)
#define EXYNOS4_G3D_OPTION                    S5P_PMUREG(0x3C68)
#define EXYNOS4_LCD0_CONFIGURATION            S5P_PMUREG(0x3C80)
#define EXYNOS4_LCD0_STATUS                   S5P_PMUREG(0x3C84)
#define EXYNOS4_LCD0_OPTION                   S5P_PMUREG(0x3C88)
#define EXYNOS4_ISP_CONFIGURATION             S5P_PMUREG(0x3CA0)
#define EXYNOS4_ISP_STATUS                    S5P_PMUREG(0x3CA4)
#define EXYNOS4_ISP_OPTION                    S5P_PMUREG(0x3CA8)
#define EXYNOS4_MAUDIO_CONFIGURATION          S5P_PMUREG(0x3CC0)
#define EXYNOS4_MAUDIO_STATUS                 S5P_PMUREG(0x3CC4)
#define EXYNOS4_MAUDIO_OPTION                 S5P_PMUREG(0x3CC8)
#define EXYNOS4_GPS_CONFIGURATION             S5P_PMUREG(0x3CE0)
#define EXYNOS4_GPS_STATUS                    S5P_PMUREG(0x3CE4)
#define EXYNOS4_GPS_OPTION                    S5P_PMUREG(0x3CE8)
#define EXYNOS4_GPS_ALIVE_CONFIGURATION       S5P_PMUREG(0x3D00)
#define EXYNOS4_GPS_ALIVE_STATUS              S5P_PMUREG(0x3D04)
#define EXYNOS4_GPS_ALIVE_OPTION              S5P_PMUREG(0x3D08)
//Apollo -
