...
//Apollo +
	SAVE_ITEM(S3C_VA_UARTx(0) + 0x00),
	SAVE_ITEM(S3C_VA_UARTx(0) + 0x04),
	SAVE_ITEM(S3C_VA_UARTx(0) + 0x08),
	SAVE_ITEM(S3C_VA_UARTx(0) + 0x0C),
	SAVE_ITEM(S3C_VA_UARTx(0) + 0x28),
	SAVE_ITEM(S3C_VA_UARTx(0) + 0x2C),
	SAVE_ITEM(S3C_VA_UARTx(0) + 0x38),

	SAVE_ITEM(S3C_VA_UARTx(1) + 0x00),
	SAVE_ITEM(S3C_VA_UARTx(1) + 0x04),
	SAVE_ITEM(S3C_VA_UARTx(1) + 0x08),
	SAVE_ITEM(S3C_VA_UARTx(1) + 0x0C),
	SAVE_ITEM(S3C_VA_UARTx(1) + 0x28),
	SAVE_ITEM(S3C_VA_UARTx(1) + 0x2C),
	SAVE_ITEM(S3C_VA_UARTx(1) + 0x38),

	SAVE_ITEM(S3C_VA_UARTx(2) + 0x00),
	SAVE_ITEM(S3C_VA_UARTx(2) + 0x04),
	SAVE_ITEM(S3C_VA_UARTx(2) + 0x08),
	SAVE_ITEM(S3C_VA_UARTx(2) + 0x0C),
	SAVE_ITEM(S3C_VA_UARTx(2) + 0x28),
	SAVE_ITEM(S3C_VA_UARTx(2) + 0x2C),
	SAVE_ITEM(S3C_VA_UARTx(2) + 0x38),

	SAVE_ITEM(S3C_VA_UARTx(3) + 0x00),
	SAVE_ITEM(S3C_VA_UARTx(3) + 0x04),
	SAVE_ITEM(S3C_VA_UARTx(3) + 0x08),
	SAVE_ITEM(S3C_VA_UARTx(3) + 0x0C),
	SAVE_ITEM(S3C_VA_UARTx(3) + 0x28),
	SAVE_ITEM(S3C_VA_UARTx(3) + 0x2C),
	SAVE_ITEM(S3C_VA_UARTx(3) + 0x38),
//Apollo -
};
