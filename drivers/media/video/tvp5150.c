...
static const struct i2c_reg_value InitValue[]={
{0x00,	0x00},
{0x03,	0x8F},
{0x04,	0xDC},
{0x07,	0x60},
...
static int tvp5150_reset(struct v4l2_subdev *sd, u32 val)
{
	...
	tvp5150_write_inittab(sd, InitValue);
...
static int tvp5150_s_fmt(struct v4l2_subdev *sd, struct v4l2_mbus_framefmt *fmt)
{
//  int index, i, num;
//	struct i2c_client *client = v4l2_get_subdevdata(sd);
//
...
static int tvp5150_enum_framesizes(struct v4l2_subdev *sd, struct v4l2_frmsizeenum *fsize)
{
	...
	fsize->discrete.width = cam_res_list[0].width;
	fsize->discrete.height = cam_res_list[0].height;
